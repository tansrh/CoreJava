...
public class Order {
	...
	public Order(String firstName, String lastName, String contact, String address, String userId, String orderId) throws InvalidUserIdException, InvalidOrderIdException {
		super();
